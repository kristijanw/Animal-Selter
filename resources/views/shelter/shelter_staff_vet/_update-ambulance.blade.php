...
<div id="editAmbulanceModal" class="modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <form id="updateAmbulanceStaff" action="{{ route('shelter_vet_staff.update', $shelterVetStaff->id ?? '') }}" enctype="multipart/form-data">
        <div class="modal-body">
          @method('PUT')
          @csrf

          <div id="dangerAmbulanceUpdate" class="alert alert-danger alert-dismissible fade show" role="alert" style="display: none;">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div id="successAmbulanceUpdate" class="alert alert-success alert-dismissible fade show" role="alert" style="display: none;">
            <strong>Uspjeh!</strong> Pružatelj veterinarske usluge uspješno izmjenjen.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="staff_vet_ambulance" placeholder="Naziv veterinarske ambulante/organizacije" value="{{ $shelterVetStaff->name ?? '' }}">
          ...
          <div class="form-group ambulance">
